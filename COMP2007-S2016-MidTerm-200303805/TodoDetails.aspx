<%@ Page Title="Todo Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TodoDetails.aspx.cs" Inherits="COMP2007_S2016_MidTerm_200303805.TodoDetails" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                ...
                <div class="form-group">
                    <asp:CheckBox ID="CompletedCheckBox" Text="Completed" Checked="false" runat="server" />
                </div>
